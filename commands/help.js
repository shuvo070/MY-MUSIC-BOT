    ...
    try {
      ...
      const musicCommandsEmbed = new EmbedBuilder()
        ...
        .addFields(
          ...
          {
            name: '⏭️ Skip',
            value: 'Skip the current playing song'
          },
          {
            name: '⏸️ Pause',
          ...
          {
            name: '⏮️ Previous',
            value: 'Play the previous song in the queue'
          },
          {
            name: '🔀 Shuffle',
            value: 'Shuffle the songs in queue'
          },
          {
            name: '📃 Playlist',
            value: 'Manage the playlists'
          }
        )
        .setImage(
      ...
      const basicCommandsEmbed = new EmbedBuilder()
        ...
        .addFields(
          ...
          {
            name: '⏱️ Time',
            value: 'Display the current song playback time'
          },
          {
            name: '🎧 Filter',
          ...
          {
            name: '🔊 Volume',
            value: 'Adjust the music volume [hearing at high volumes is risky]'
          }
        );
      ...
      const row = new ActionRowBuilder()
        .addComponents(
          ...
          new ButtonBuilder()
            ...
            .setStyle(ButtonStyle.Link)
            .setURL(
              'https://www.youtube.com/channel/UCPbAvYWBgnYhliJa1BIrv0A'
            )
        );
      ...
      // Avoid replying twice if interaction was already acknowledged
